...
def _load_library():
    ...
    if sys.platform.startswith("darwin"):
        libfile = osp.abspath(osp.join(osp.dirname(__file__),"mujoco131/bin/libglfw.3.dylib"))
    elif sys.platform.startswith("linux"):
        libfile = osp.abspath(osp.join(osp.dirname(__file__),"mujoco131/bin/libglfw.so.3"))
    elif sys.platform.startswith("win"):
        libfile = osp.abspath(osp.join(osp.dirname(__file__),"mujoco131/bin/mujoco/glfw3.dll"))
    else:
